...
## Decision
All Hub runtime data artifacts are stored in Vault under `Vault/Studio_Hub/knowledge/hub/`. The Hub repo (`Studio_Hub`) stores only logic: agent-context files, skills, tasks, templates, and schema documentation.
